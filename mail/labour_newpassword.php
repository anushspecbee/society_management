                       ...
                       <form id="register-form" role="form" autocomplete="off" class="form" method="post" action=""> 
                         ...
                         <div class="form-group">
                           <div class="input-group">
                             ...
                             <input id="newpassword" name="mail" placeholder="Enter Email" class="form-control"  type="email">
                             <input id="newcpassword" name="newcpassword" placeholder="type new password" class="form-control"  type="password">

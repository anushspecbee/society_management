...
<div class="wrapper fadeInDown">
  <div id="formContent">
    <!-- Tabs Titles -->
     ...
     <h2 class="inactive underlineHover"><a href="labour_details.php" target="blank">Labour Section </a></h2>
...
<h4 class="card-title"><u>Electricity</u></h4>
 <table class="table table-striped">
   ...
   <?php while($electricity_issue = $check->fetch()) { ?>
      <td>
...
<table class="table table-striped">
    <thead>
      ...
      <?php while($water_issue = $result->fetch()) { ?>
...
<table class="table table-striped">
   ...
   <?php while($parking_issue = $result_parking->fetch()) { ?>
...
<table class="table table-striped">
   ...
   <?php while($security_issue = $result_security->fetch()) { ?>
...
<table class="table table-striped">
   ...
   <?php while($clean_issue = $result_clean->fetch()) { ?>
